<template>
  <view class="container">
    ...
    <view class="button-group">
      <button class="button move" :disabled="moveDisable">移动到</button>
      <button class="button cancelCollection" :disabled="cancelDisable">取消收藏</button>
      <button class="button management" :disabled="manageDisable">目录管理</button>
    </view>
  </view>
</template>
...
// emit all select
const emit = defineEmits(['allSelected'])
